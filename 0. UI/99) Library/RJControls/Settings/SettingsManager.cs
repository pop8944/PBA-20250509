        ...
        public static void LoadApperanceSettings()
        {
            ...
            switch (UIAppearance.Style)
            {
                ...
                case UIStyle.Lisianthus:
                    UIAppearance.PrimaryStyleColor = Color.FromArgb(41, 44, 66);
                    if (UIAppearance.Theme == UITheme.Dark)
                        UIAppearance.StyleColor = ColorEditor.Darken(Color.FromArgb(41, 44, 66), 10);
                    else UIAppearance.StyleColor = ColorEditor.Lighten(Color.FromArgb(41, 44, 66), 15);
                    break;
                ...
                case UIStyle.Supernova:
                    UIAppearance.StyleColor = Color.FromArgb(41, 44, 66);
