...
{
    internal class DropdownMenuColors : ProfessionalColorTable
    {
        /// <summary>
        ...
        { get { return dropdownMenuBackground; } }///Gets the solid background color of the <see cref="ToolStripDropDown"/>

        public override Color MenuBorder
        { get { return dropdownMenuBorder; } }///Gets the color that is the border color to use on a <see cref="MenuStrip"/>

        public override Color MenuItemBorder
        { get { return menuItemBorder; } }///Gets the border color to use with a <see cref="ToolStripMenuItem"/>

        public override Color MenuItemSelected
        { get { return menuItemSelected; } }///Gets the solid color to use when a ToolStripMenuItem other than the top-level <see cref="ToolStripMenuItem"/> is selected

        public override Color ImageMarginGradientBegin
        { get { return leftColumnGradientBegin; } }///Gets the starting color of the gradient used in the image margin of a <see cref="ToolStripDropDown"/>

        public override Color ImageMarginGradientMiddle
        { get { return leftColumnGradientMiddle; } }///Gets the middle color of the gradient used in the image margin of a <see cref="ToolStripDropDown"/>

        public override Color ImageMarginGradientEnd
        { get { return leftColumnGradientEnd; } }///Gets the end color of the gradient used in the image margin of a <see cref="ToolStripDropDown"/>
    }
}