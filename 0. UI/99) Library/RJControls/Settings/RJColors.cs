...
namespace IF_UI.Settings
{
    public static class RJColors
    {
        ...
        //-> RJColors
        public static readonly Color SideMenuColor = Color.FromArgb(64, 73, 108);
        ...
        public static readonly Color DarkBackground = Color.Black;// Color.FromArgb(41, 44, 66);

        public static readonly Color DarkItemBackground = Color.Black;//Color.FromArgb(41, 44, 66);
        public static readonly Color DarkActiveBackground = Color.Black;//Color.FromArgb(41, 44, 66);
        public static readonly Color DarkTextColor = Color.Black;//Color.White;
        ...
        public static readonly Color DeactiveDark = Color.FromArgb(41, 44, 66);
