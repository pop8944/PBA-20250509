...
namespace PanasonicPlcTest.Mewtocol
{
    public static class MewtocolHelpers
    {
        ...
        internal static string BuildBCCFrame(this string asciiArr)
        {
            ...
            temp = asciiArr.ToCharArray(); //문자열을 문자 변수에 각각 집어 넣음
            ...
            return asciiArr.Insert(asciiArr.Length, hex);
        ...
        internal static bool[] ParseRCWordBit(this string _onString, int _blockSize = 4)
        {
            bool[] bits = new bool[8] { false, false, false, false, false, false, false, false };
            ...
            if (res.Success)
            {
                string value = _onString.Substring(res.Length - 1);
                if (value.Length >= 8)
                {
                    bits[0] = (value[0] == '1');
                    bits[1] = (value[1] == '1');
        ...
        public static string ParseDTString(this string _onString)
        {
            ...
            if (res.Success)
            {
                string val = res.Groups[2].Value.Substring(0, res.Groups[2].Value.Length - 1);
