...
public enum AXT_BASE_BOARD : uint
{
    ...
    AXT_PCIE_Cxx05RTEX = 0xDD     // PCI bus, Half size, ECAT(DSP Based) controller.
}
...
public class CAXHS
{
    ...
    public static readonly uint WM_AXL_INTERRUPT = (WM_USER + 1001);
    public static readonly uint MAX_SERVO_ALARM_HISTORY = 15;
