    ...
    public partial class RJSettingsForm : RJChildForm
    {
        ...
        {//Restart application
            ...
            /* Note: When executing the application from visual studio, the configuration file is saved
              * in the folder IF_UI.vshost.exe. And when restarting the application the configuration
              * file is obtained from the C:\Users\YourUsername\AppData\Local\IF_UI\IF_UI.exe folder,
			  ...
			  * C:\Users\YourUsername\AppData\Local\IF_UI\IF_UI.exe configuration. If you want to
        ...
        private void cbStyles_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (style)
            {
                ...
                case UIStyle.Lisianthus:
                    panelTitleBar.BackColor = Color.FromArgb(41, 44, 66);
                    break;
