...
namespace IF_UI.RJControls
{
    public class RJDataGridView : DataGridView
    {
        ...
        private DataGridViewCellStyle ColumnHeaderStyle; // Sets or gets the style of the column headers.
        private DataGridViewCellStyle RowHeaderStyle; // Sets or gets the style of row headers
        private DataGridViewCellStyle RowStyle; // Sets or gets the Rows style
