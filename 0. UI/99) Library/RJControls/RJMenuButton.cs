...
namespace IF_UI.RJControls
{
    public class RJMenuButton : IconButton
    {
        ...
        private Color supernovaColor = Color.Red;
        ...
        //Static Fields
        private static readonly Color deactivateItemsColor = Color.FromArgb(83, 97, 150);//Sets or Gets Icon and text color when the menu button is deactivated

        private static readonly Color activateForeColor = Color.FromArgb(255, 255, 255);//Sets or gets Text Color when menu button is activated
        private static readonly Color activateBackColor = Color.FromArgb(83, 97, 150);//Sets or gets back Color when menu button is activated and dropdown menu is displayed
        ...
        {//this method draws the arrow icon of the drop-down menu button
            ...
            pbDropdownArrowIcon.IconColor = Color.Silver;
        ...
        private void DropdownMenu_VisibleChanged(object sender, EventArgs e)
        {
            ...
            this.BackColor = DEFINE.COLOR_NAVY;
            this.ForeColor = Color.Silver;
            this.IconColor = Color.Silver;
