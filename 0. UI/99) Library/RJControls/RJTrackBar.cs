...
{
    internal class RJTrackBar : TrackBar
    {
        /// <summary>
        ...
        // RECT structure
        private struct RECT
        { public int Left, Top, Right, Bottom; } // The RECT structure defines the coordinates of the upper left and lower right corners of a rectangle.
