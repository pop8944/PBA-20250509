...
{
    public partial class FormMenu_MainFrame_Backup : Form
    {
        ...
        public FormMenu_MainFrame_Backup()
        {
            InitializeComponent();
        ...
        private bool InitUI()
        {
            try
            {
                ...
                if (comboCountry.SelectedItem.ToString() == Setting_Enviroment.COUNTRY.KOR.ToString()) picCountry.Image = IntelligentFactory.Properties.Resources.KOR;
                if (comboCountry.SelectedItem.ToString() == Setting_Enviroment.COUNTRY.POL.ToString()) picCountry.Image = IntelligentFactory.Properties.Resources.POL;
                if (comboCountry.SelectedItem.ToString() == Setting_Enviroment.COUNTRY.MAL.ToString()) picCountry.Image = IntelligentFactory.Properties.Resources.MAL;

                if (!Global.CognexLicense_Check())
                {
                    statusLicense.BackColor = Color.Green;
                }
                else
                {
                    statusLicense.BackColor = DEFINE.COLOR_RED;
                }
        ...
        private void timerDateTime_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    btnMenuAuthorization.BackColor = DEFINE.COLOR_TEAL;
                    btnMenuAuthorization.Text = "OPERATOR";
                }
                else if (Global.Instance.System.Authorization == DEFINE.AUTHORIZATION.ENGINEER)
                {
                    btnMenuAuthorization.BackColor = DEFINE.COLOR_RED;
                    btnMenuAuthorization.Text = "ENGINEER";
                }
                else if (Global.Instance.System.Authorization == DEFINE.AUTHORIZATION.MASTER)
                {
                    btnMenuAuthorization.BackColor = DEFINE.COLOR_RED;
                    btnMenuAuthorization.Text = "MASTER";
                }
            }
            catch (Exception ex)
            {
        ...
        private void timerConnection_Tick(object sender, EventArgs e)
        {
            ...
            if (Global.Instance.System.Recipe.Task_TrainImage != null)
            {
                if (Global.Instance.System.Recipe.Task_TrainImage.Status == TaskStatus.Running)
                {
                    ...
                    lblRecipeLoading.Text = $"Array ({Global.Instance.System.Recipe.TrainArrayIndex + 1}/{Global.Instance.System.Recipe.ArrayCount}) Trainning";
                }
                else
                {
                    if (Global.Progress.desc == "Setting Train Image...")
                        Global.OnEnd_Progress();
                    processBar_TrainImage.Value = 0;
                    pnlRecipeLoading.Visible = false;
            ...
            {
                statusARC.BackColor = Color.Green;
            }
            else
            {
                statusARC.BackColor = DEFINE.COLOR_RED;
            }

            if (Global.Device.EyeD != null && Global.Device.EyeD.IsOpen)
            {
                statusEyeD.BackColor = Color.Green;
            }
            else
            {
                statusEyeD.BackColor = DEFINE.COLOR_RED;
            }


            #region Camera
            if (Global.Instance.Device.Cameras != null)
            {
                if (Global.Instance.Device.Cameras.Count > 0)
                {
                    if (Global.Instance.Device.Cameras[0] != null)
                    {
                        statusCamera.BackColor = Global.Device.Cameras[0].IsOpen ? Color.Green : DEFINE.COLOR_RED;
                    }
                }
            }
            ...
            {
                statusLightController.BackColor = Global.Device.LightController.IsOpen ? Color.Green : DEFINE.COLOR_RED;
            }
            #endregion Light

            #region IO
            if (Global.Instance.Device.DIO_BD != null)
            {
                statusIO.BackColor = Global.Device.DIO_BD.IsOpen ? Color.Green : DEFINE.COLOR_RED;
            }
            #endregion IO
            ...
            {
                statusBuffer.Text = $"NG BUFF {Global.Device.NGBUFFER.CycleTime}ms";
                statusBuffer.BackColor = Global.Device.NGBUFFER.IsOpen ? Color.Green : DEFINE.COLOR_RED;
            }
            #endregion MEWTOCOL
        }
        ...
        private bool EnableMenu(bool bEnable = true)
        {
            try
            {
                ...
                btnMenuModel.Enabled = bEnable;
                btnMenuIO.Enabled = bEnable;
                btnMenuSetting.Enabled = bEnable;
                //btnMenuVisionTeaching.Enabled = bEnable;
                //btnMenuClose.Enabled = bEnable;
                //btnViewer.Enabled = bEnable;

                btnMenuAuthorization.Enabled = bEnable;
        ...
        private void timerAlarm_Tick(object sender, EventArgs e)
        {
            ...
            if (CAlarm.Exists)
            {
                ...
                if (pnlAlarm.Width != 810) pnlAlarm.Width = 810;
                ...
                lblNotice.ForeColor = DEFINE.COLOR_RED;
                lblAlarm.Text = lblNotice.Text = $"ALARM : {strDesc}";
            ...
            {
                if (pnlAlarm.Visible == true) pnlAlarm.Visible = false;
                if (lblNotice.ForeColor != Color.White) lblNotice.ForeColor = Color.White;
            }
        }
        ...
        private void btnMenuMain_MouseHover(object sender, EventArgs e)
        {
            btnMenuMain.Image = Properties.Resources.Home50_MouseHover;
            btnMenuMain.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuMain_MouseLeave(object sender, EventArgs e)
        {
            btnMenuMain.Image = Properties.Resources.Home50_Normal;
            btnMenuMain.ForeColor = Color.White;
        }

        private void btnMenuModel_MouseHover(object sender, EventArgs e)
        {
            btnMenuModel.Image = Properties.Resources.Model50_MouseHover;
            btnMenuModel.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuModel_MouseLeave(object sender, EventArgs e)
        {
            btnMenuModel.Image = Properties.Resources.Model50_Normal;
            btnMenuModel.ForeColor = Color.White;
        }

        private void btnMenuVisionTeaching_MouseHover(object sender, EventArgs e)
        {
            btnMenuVisionTeaching.Image = Properties.Resources.Vision50_MouseHover;
            btnMenuVisionTeaching.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuVisionTeaching_MouseLeave(object sender, EventArgs e)
        {
            btnMenuVisionTeaching.Image = Properties.Resources.Vision50_Normal;
            btnMenuVisionTeaching.ForeColor = Color.White;
        }

        private void btnMenuIO_MouseHover(object sender, EventArgs e)
        {
            btnMenuIO.Image = Properties.Resources.DIO50_MouseHover;
            btnMenuIO.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuIO_MouseLeave(object sender, EventArgs e)
        {
            btnMenuIO.Image = Properties.Resources.DIO50_Normal;
            btnMenuIO.ForeColor = Color.White;
        }

        private void btnMenuRMS_MouseHover(object sender, EventArgs e)
        {
            btnMenuRMS.Image = Properties.Resources.RMS50_MouseHover;
            btnMenuRMS.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuRMS_MouseLeave(object sender, EventArgs e)
        {
            btnMenuRMS.Image = Properties.Resources.RMS50_Normal;
            btnMenuRMS.ForeColor = Color.White;
        }

        private void btnMenuSetting_MouseHover(object sender, EventArgs e)
        {
            btnMenuSetting.Image = Properties.Resources.Setting50_MouseHover;
            btnMenuSetting.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuSetting_MouseLeave(object sender, EventArgs e)
        {
            btnMenuSetting.Image = Properties.Resources.Setting50_Normal;
            btnMenuSetting.ForeColor = Color.White;
        }

        private void btnMenuAuthorization_MouseHover(object sender, EventArgs e)
        {
            btnMenuAuthorization.Image = Properties.Resources.Login50_MouseHover;
            btnMenuAuthorization.ForeColor = Color.FromArgb(255, 96, 125, 139);
        }

        private void btnMenuAuthorization_MouseLeave(object sender, EventArgs e)
        {
            btnMenuAuthorization.Image = Properties.Resources.Login50_Normal;
            btnMenuAuthorization.ForeColor = Color.White;
        }
        ...
        private void timerStatus_Tick(object sender, EventArgs e)
        {
            ...
            lblStopReason.Text = Global.Data.StopReason;
            if (Global.System.Mode == CSystem.MODE.AUTO)
            {
            ...
            {
                if (lblMode.Text != "ALARM") lblMode.Text = "ALARM";
