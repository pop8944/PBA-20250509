...
{
    public class RJMainForm : IF_BaseForm
    {
        /// This class inherits from the <see cref="IF_BaseForm"/> class
        ///
        ///<summary>
        ...
        private void InitializeItems()
        {
            ...
            #endregion -Control Instantiation
            ...
            #endregion -Desktop Header (Child Form Options)
            ...
            #endregion -Desktop (Cliente area - Child form container)
            ...
            #endregion -RJ Main Form Properties
        }
        ...
        protected void OpenChildForm<childForm>(Func<childForm> _delegate) where childForm : RJChildForm
        {
            ...
            #endregion - Show Child Form as a New Instance
            ...
            #endregion - Redisplay Existing Form or Child Form
