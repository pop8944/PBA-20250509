...
namespace IF_UI.RJForms
{
    public class IF_BaseForm : Form
    {
        ...
        public IF_BaseForm()
        {
            ...
            btnClose.Image = IntelligentFactory.Properties.Resources.CloseWhite;
            ...
            btnMaximize.Image = IntelligentFactory.Properties.Resources.MaximizeWhite;
            ...
            btnMinimize.Image = IntelligentFactory.Properties.Resources.MinimizeWhite;
            ...
            if (isPrimaryForm)//If it is a primary form (e.g LoginForm and MainForm)
            {
                if (UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light) //If the style is supernova and the theme is light: Sets the icon to a dark color
                {
                    if (this.WindowState == FormWindowState.Normal)
                        btnMaximize.Image = IntelligentFactory.Properties.Resources.MaximizeDark;
                    else
                        btnMaximize.Image = IntelligentFactory.Properties.Resources.RestoreDark;
                }
                else //If it is any other theme or style: Sets the icon to a light color
                {
                    if (this.WindowState == FormWindowState.Normal)
                        ...
                        btnMaximize.Image = IntelligentFactory.Properties.Resources.RestoreWhite;
                }
            }
        ...
        private void ApplyAppearanceSettings()
        {
            if (UIAppearance.Style == UIStyle.Supernova)//if the style is supernova
            {
                ...
                if (isPrimaryForm)
                {
                    ...
                    {
                        this.btnClose.Image = IntelligentFactory.Properties.Resources.CloseDark;
                        this.btnMaximize.Image = IntelligentFactory.Properties.Resources.MaximizeDark;
                        this.btnMinimize.Image = IntelligentFactory.Properties.Resources.MinimizeDark;
                    }
                }
            }
        }
        ...
        private void SnapWindowLeft_Click(object sender, EventArgs e)
        { SnapWindowLeft(); }

        private void SnapWindowRight_Click(object sender, EventArgs e)
        { SnapWindowRight(); }

        private void ExitSnapWindow_Click(object sender, EventArgs e)
        { ExitSnapWindow(); }
        ...
        {
            if (isPrimaryForm && UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light)
                btnMinimize.Image = IntelligentFactory.Properties.Resources.MinimizeDark;
        }
        ...
        {
            if (isPrimaryForm && UIAppearance.Style == UIStyle.Supernova && UIAppearance.Theme == UITheme.Light)
                btnClose.Image = IntelligentFactory.Properties.Resources.CloseDark;
        }

        #endregion -> Event Methodss
    }
}